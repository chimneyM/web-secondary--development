...
if (process.env.NODE_ENV !== "production") {
  ...
  const customConfig = {
    componentId: "111111",
    data: JSON.stringify({"list":[{"lngLat":[116.29224296738022,31.789542276642237]},{"lngLat":[116.34580131699158,31.687348707429393]},{"lngLat":[116.5167760484357,31.80821690290233]}],"type":"area"}),
    saveValue: [],
    onChange: (values: any) => {
      console.log(values);
    },

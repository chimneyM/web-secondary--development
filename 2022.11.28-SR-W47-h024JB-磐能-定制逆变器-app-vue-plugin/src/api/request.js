...
if (process.env.NODE_ENV === "development") {
   document.cookie = "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY3Mzg1MzczMDM4MiwidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.aH3XnkqECvu1r_-vnSl4uCPkChUmcEU-qQpbnApuUsA";
   apiContextPath = "/api";
}

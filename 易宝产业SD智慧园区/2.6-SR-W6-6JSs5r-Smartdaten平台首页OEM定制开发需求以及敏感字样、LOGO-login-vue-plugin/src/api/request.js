...
if (process.env.NODE_ENV === "development") {
  document.cookie = "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY3NTgzODU5MTEyOSwidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.6UrV-k0yICHuQjqOQPqCGTpkOnLXb_KtCPRyQHpu0Io";

...
if (process.env.NODE_ENV === "development") {
   document.cookie = "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY3NDAwNjI5NTgyNywidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.wtxcQwv5qFnetCBJ4Vr0jqE-W_6wuMU4WeoJMfs6vTE";
   apiContextPath = "/api";
}

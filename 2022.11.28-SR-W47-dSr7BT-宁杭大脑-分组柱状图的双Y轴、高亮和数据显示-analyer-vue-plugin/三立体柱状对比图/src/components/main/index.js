...
export default class Main extends Component {
  ...
  constructor(props) {
    ...
    if (props.options?.externalVariables) {
      ...
      this.第一柱数值左右位置 = options?.externalVariables?.第一柱数值左右位置 || 7;
      this.第二柱数值左右位置 = options?.externalVariables?.第二柱数值左右位置 || -1;
      this.第三柱数值左右位置 = options?.externalVariables?.第三柱数值左右位置 || -8;
      ...
      this.第三组名称 = options?.externalVariables?.第三组名称 || "";
      ...
      this.柱状图三顶颜色 = options?.externalVariables?.柱状图二顶颜色 || "#F5CFAC";
      ...
      this.柱状图三左百分0颜色 = options?.externalVariables?.柱状图三左百分0颜色 || "#BB875B";
      this.柱状图三左百分百颜色 = options?.externalVariables?.柱状图三左百分百颜色 || "#3D2517";
      ...
      this.柱状图三右百分0颜色 = options?.externalVariables?.柱状图二右百分0颜色 || "#E7AD7B";
      this.柱状图三右百分百颜色 = options?.externalVariables?.柱状图二右百分百颜色 || "#694227";
  ...
  initEcharts = (data) => {
    ...
    const myChart = echarts.init(this.refs.head3D123);
    ...
    let option = {
      ...
      legend: {
        ...
        data: [
          ...
          { name: this.第三组名称, itemStyle: { color: this.柱状图三顶颜色 } },
        ],
        icon: "rect",
        itemWidth: 12,
        itemHeight: 12,
      ...
      series: [
        {
          ...
          renderItem: (params, api) => {
            ...
            location = [location[0] - Number(this.柱体宽度) * 2, location[1]];
            var location1 = api.coord([api.value(0), 0]);
            location1 = [location1[0] - Number(this.柱体宽度) * 2, location1[1]];
            return {
              type: "group",
              children: [
                {
        ...
        },
        {
          ...
          renderItem: (params, api) => {
            let cubeLeftStyle = new echarts.graphic.LinearGradient(0, 0, 0, 1, [
              {
                offset: 0,
                color: this.柱状图三左百分0颜色,
              },
              {
                offset: 1,
                color: this.柱状图三左百分百颜色,
              },
            ]);
            let cubeRightStyle = new echarts.graphic.LinearGradient(0, 0, 0, 1, [
              {
                offset: 0,
                color: this.柱状图三右百分0颜色,
              },
              {
                offset: 1,
                color: this.柱状图三右百分百颜色,
              },
            ]);
            let cubeTopStyle = new echarts.graphic.LinearGradient(0, 0, 0, 1, [
              {
        ...
        },
        {
          ...
          label: {
            ...
            normal: {
              ...
              fontSize: 12,
              color: "transparent",
              offset: [Number(this.第三柱数值左右位置), -10],
            },
          },
          itemStyle: {
            color: "transparent",
    ...
    resizeObserver.observe(document.querySelector(".analyzer-secondary"));
